        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
            <div className="lg:col-span-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
                {[
                  ...
                  <div key={i} className="p-10 rounded-[48px] bg-gray-50 border border-gray-100 hover:bg-white hover:shadow-2xl transition-all duration-500 group">
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-32 p-12 rounded-[56px] bg-brand-green text-white shadow-2xl shadow-brand-green/20">
