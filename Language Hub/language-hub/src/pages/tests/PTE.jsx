    ...
    <div className="pt-20 bg-[#f8f9ff]">
      ...
      <section className="py-32 px-6">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            {[
              ...
              <motion.div
                ...
                className="p-16 rounded-[64px] bg-white shadow-xl shadow-gray-100 border border-gray-50 group hover:border-brand-green/30 transition-all duration-700 hover:translate-y-[-10px]"
              >
          ...
          <div className="mt-32 p-20 rounded-[80px] bg-gray-900 text-white flex flex-col lg:flex-row items-center justify-between gap-16 relative overflow-hidden">
             <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-brand-green/20 rounded-full blur-[100px]" />
             <div className="relative z-10 max-w-2xl text-center lg:text-left">
                <h2 className="text-6xl font-black mb-8 leading-tight tracking-tighter">Ready to conquer the <span className="text-brand-green">Pearson Test?</span></h2>
             ...
             <button 
               ...
               className="relative z-10 px-16 py-8 bg-brand-green text-white rounded-[40px] text-2xl font-black hover:scale-105 transition-all shadow-2xl shadow-brand-green/40 flex items-center gap-4"
             >
