...
const UAE = () => {
  ...
  return (
    <div className="pt-20 bg-white text-balance">
      <SEO title="Study in UAE | Global Business & Innovation | Bluestone Overseas" description="Study in one of the world's most internationalized education systems. Expert guidance for UAE university admissions." />
      
      {/* Hero Section */}
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&q=80&w=2070" className="w-full h-full object-cover brightness-50" alt="UAE" />
        ...
        <div className="container mx-auto px-6 relative z-10 text-center text-white p-6">
          ...
          >
            ...
            <span className="text-sm font-black uppercase tracking-widest text-white">Study in UAE</span>
          </motion.div>
          <motion.h1 
          ...
          <p className="max-w-2xl mx-auto text-2xl font-bold italic opacity-90 px-4">
             "Study in a global crossroads of business and innovation. Join prestigious international branch campuses in one of the world's most dynamic economies."
          </p>
        </div>
      </section>
      ...
      <section className="py-32 px-6">
        <div className="container mx-auto">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {[
                { title: 'Global Business Hub', desc: 'Study at the center of international trade, finance, and logistics with huge corporate exposure.', img: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&q=80&w=600' },
                { title: 'Branch Campuses', desc: 'Secure degrees from top-tier UK, US, and Australian universities right in the heart of the Middle East.', img: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&q=80&w=600' },
                { title: 'Innovation & Tech', desc: 'Benefit from massive investments in AI, clean energy, and smart city technology.', img: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=600' }
              ].map((item, i) => (
                <motion.div 
                  key={i}
                  whileHover={{ y: -20 }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
               <div>
                  ...
                  <div className="space-y-12">
                     {[
                       ...
                       { title: 'Visa & Permit Support', desc: 'Expert assistance with student visa sponsorship and documentation.' },
                       { title: 'Post-study Guidance', desc: 'Helping you navigate the unique career opportunities in the region.' }
                     ].map((feat, i) => (
               ...
               <div className="relative">
                  ...
                  <div className="bg-gray-800 p-16 rounded-[60px] relative z-10 border border-white/5 shadow-2xl">
                     <h3 className="text-4xl font-black mb-10 border-b border-white/10 pb-6 uppercase tracking-tight">UAE Study Package</h3>
