...
const Footer = () => {
    return (
        <footer id="contact" className="bg-[#050505] text-white pt-20 md:pt-32 pb-12 px-6 relative overflow-hidden">
            ...
            <div className="container mx-auto relative z-10">
                ...
                <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-8 text-gray-600 text-[10px] font-black uppercase tracking-widest text-center md:text-left">
