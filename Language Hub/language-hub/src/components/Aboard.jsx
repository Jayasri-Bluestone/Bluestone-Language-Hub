...
const Abroad = () => {
  ...
  return (
    <section id="aboard" className="py-32 bg-white px-6 overflow-hidden relative">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
           <div className="max-w-2xl">
              ...
              >
                ...
                <span className="text-xs font-black text-brand-green uppercase tracking-widest">Global Standards</span>
              </motion.div>
        ...
        <div className="overflow-x-auto pb-10 custom-scrollbar">
           <div className="flex gap-4 h-[600px] min-w-[1600px] w-full">
            {destinations.map((dest, i) => (
              <motion.div
                ...
                animate={{ 
                  ...
                  minWidth: hoveredIndex === i ? '500px' : '200px'
                }}
                transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
                className="relative rounded-[40px] overflow-hidden group cursor-pointer"
              >
                <Link to={dest.link} className="block w-full h-full">
                  ...
                  {/* Icon Overlay */}
                  <div className="absolute top-8 left-1/2 -translate-x-1/2 md:translate-x-0 md:left-8 w-16 h-16 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center border border-white/30 z-10 transition-all duration-500 group-hover:bg-white group-hover:scale-110">
                    <dest.icon className="w-8 h-8 text-white group-hover:text-brand-green transition-colors" />
                  </div>
