...
const CoursesScroll = () => {
  ...
  return (
    <section ref={targetRef} className="relative h-[300vh] bg-brand-green-soft/30">
      <div className="sticky top-0 h-screen flex flex-col justify-center overflow-hidden">
        <div className="container mx-auto px-6 mb-12 relative z-20">
            ...
            <h2 className="text-6xl md:text-8xl font-black text-gray-900 tracking-tighter uppercase leading-none">
          ...
          {courses.map((course, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 p-12 flex flex-col justify-end z-10">
                ...
                <h3 className="text-5xl font-black text-white mb-4 tracking-tight uppercase">{course.title}</h3>
                <p className="text-lg text-white/70 font-bold leading-relaxed mb-8 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                  {course.desc}
                </p>
