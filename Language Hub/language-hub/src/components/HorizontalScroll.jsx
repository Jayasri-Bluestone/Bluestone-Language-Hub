        ...
        >
            <div className="md:sticky md:top-0 md:h-screen flex flex-col md:flex-row items-center overflow-hidden z-10">
                <motion.div
                    ...
                    className="flex flex-col md:flex-row gap-16 px-6 md:px-[10vw] relative z-20 w-full md:w-max items-center md:items-stretch"
                >
                    {/* Main Reveal Text */}
                    <div className="flex-shrink-0 w-full md:w-[50vw] h-full flex flex-col justify-center text-center md:text-left">
                        <motion.span
                        ...
                        <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-[1] md:leading-[1] tracking-relaxed uppercase">
                            WE SHAPE <br />
                    ...
                    {items.map((item, i) => (
                        <div key={i} className="flex-shrink-0 w-full md:w-[450px] h-[400px] md:h-[500px] flex flex-col justify-end p-8 md:p-20 rounded-[40px] md:rounded-[80px] relative overflow-hidden group shadow-2xl transition-all duration-1000 hover:translate-y-[-20px] border border-gray-100">
                            ...
                            <div className="relative z-10 text-white">
                                ...
                                <h3 className="text-4xl md:text-5xl font-black mb-4 md:mb-8 tracking-tighter leading-tight uppercase">{item.title}</h3>
                                <p className="text-lg md:text-xl opacity-70 leading-relaxed font-bold max-w-md">
                                    {item.text}
                                </p>
                    ...
                    <div className="flex-shrink-0 w-full md:w-[20vw] flex flex-col justify-center items-center text-center py-10">
                        <motion.h2
                            whileInView={{ scale: [0.9, 1.1, 1], rotate: [0, 2, -2, 0] }}
                            className="text-4xl md:text-5xl font-black text-gray-900 mb-12 md:mb-16 leading-[1] uppercase"
                        >
                            Ready to <br /> <span className="text-gradient uppercase">LEAP?</span>
                        </motion.h2>
                        <div className="p-1.5 md:p-2 rounded-full bg-green-gradient shadow-[0_30px_100px_rgba(34,197,94,0.4)]" onClick={openContactModal}>
                            <button className="px-10 py-4 bg-white text-brand-green rounded-full text-lg md:text-xl font-black hover:bg-transparent hover:text-white transition-all transform hover:scale-105 active:scale-95 flex items-center gap-4">
