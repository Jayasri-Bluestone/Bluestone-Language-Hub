      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div className="relative rounded-[64px] overflow-hidden border border-brand-green/10 shadow-2xl">
               ...
               <div className="absolute inset-0 bg-gradient-to-t from-brand-green/60 to-transparent flex items-end p-12">
                   <div className="text-white">
                      <div className="text-5xl font-black mb-2 tracking-tighter">2015</div>
                      <div className="text-sm font-black uppercase tracking-widest opacity-80">Founded to Empower Students</div>
                   </div>
               </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
               {[
                 ...
                 <div key={i} className="p-8 rounded-[40px] bg-brand-green-soft/50 border border-brand-green/5 group hover:bg-white hover:shadow-xl transition-all duration-500">
