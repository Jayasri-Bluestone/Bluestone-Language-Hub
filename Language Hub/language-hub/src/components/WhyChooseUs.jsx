        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {reasons.map((reason, i) => (
            <motion.div
              ...
              className="p-12 rounded-[56px] bg-white border border-gray-100 shadow-[0_20px_60px_rgba(0,0,0,0.03)] hover:shadow-[0_40px_80px_rgba(34,197,94,0.08)] transition-all duration-700 group hover:border-brand-green/10"
            >
