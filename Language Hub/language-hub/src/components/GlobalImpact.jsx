                            ...
                            <div className="aspect-[4/5] overflow-hidden rounded-[32px] md:rounded-[64px] bg-brand-green relative group">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center z-10">
                                    <motion.div
                                        ...
                                        className="w-32 h-32 bg-white/20 backdrop-blur-md rounded-full shadow-2xl flex items-center justify-center mb-10 border border-white/20"
                                    >
                                        <Globe2 className="w-16 h-16 text-white" />
                                    </motion.div>

                                    <div className="md:mt-100 p-6 md:p-10 rounded-3xl md:rounded-[48px]">
                                        <h5 className="text-lg md:text-3xl font-black text-white mb-4 md:mb-6 tracking-tight uppercase">India to the <span className="text-brand-green uppercase">World</span></h5>
                                        <p className="text-white/80 font-bold text-base md:text-lg leading-relaxed mb-6 md:mb-8">Headquartered in Coimbatore with branches across South India, empowering global careers.</p>

                                        <div className="flex flex-wrap justify-center gap-4">
                                            {['USA', 'UK', 'Canada', 'Australia', 'Germany'].map((city) => (
                                                <span key={city} className="px-4 py-2 bg-white/10 text-white text-[8px] md:text-xs font-black rounded-full border border-white/20 hover:bg-brand-green hover:border-brand-green transition-colors">
                                                    {city}
                                                </span>
                                            ))}
                                        </div>
                                ...
                                {[...Array(6)].map((_, i) => (
                                    <motion.div
                                        ...
                                        className="absolute w-2 h-2 bg-brand-green rounded-full shadow-lg shadow-brand-green/50"
                                        style={{
