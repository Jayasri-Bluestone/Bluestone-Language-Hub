      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-400 mb-16 leading-relaxed font-semibold max-w-xl">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute inset-0 bg-green-gradient rounded-[80px] blur-3xl opacity-10 transform translate-x-4 translate-y-4" />
            <div className="relative bg-white p-6 rounded-[84px] border border-brand-green/10 shadow-[0_40px_100px_-20px_rgba(34,197,94,0.15)]">
              <div className="aspect-[4/5] overflow-hidden rounded-[64px] bg-brand-green-soft/50 relative group">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center z-10">
                   ...
                   <div className="bg-white/80 backdrop-blur-xl p-10 rounded-[48px] shadow-xl border border-white/60">
                      <h5 className="text-4xl font-black text-gray-900 mb-6 tracking-tight">India to the <span className="text-brand-green">World</span></h5>
                      <p className="text-gray-500 font-bold text-lg leading-relaxed mb-8">Headquartered in Coimbatore with branches in Chennai, Trichy, Erode, Tirunelveli, and more.</p>
            ...
            <motion.div
               ...
               className="absolute -right-8 top-1/2 -translate-y-1/2 bg-white p-6 rounded-3xl shadow-2xl border border-brand-green/10 z-20 flex items-center gap-4"
            >
