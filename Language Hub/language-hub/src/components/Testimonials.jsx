        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
           {reviews.map((review, i) => (
             <motion.div
               ...
               className="p-12 rounded-[56px] border border-brand-green/10 bg-white shadow-[0_20px_50px_rgba(0,0,0,0.02)] relative group hover:border-brand-green/20 transition-all duration-700"
             >
